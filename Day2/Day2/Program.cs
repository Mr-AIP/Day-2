            ...
            vault = Console.ReadLine();
                ...
                switch (vault)
                {
                    ...
                    case ("7"):
                        ...
                        double distance = 10, day = 1, distancePerDay = 10;
                        while (true)
                        {
                            if (distance > 20.0)
                                break;
                        ...
                        Console.WriteLine($"Человек преодолел 20 км за {day} дней");
                        day = 1;
                        distance = 10;
                        while (distance < 100)
                        {
                        ...
                        Console.WriteLine($"Человек  суммарно преодолел больше 100км за {day} дней");
                        Console.ReadKey();
                        break;
                    case ("8"):
                        long factorial = 1, n;
